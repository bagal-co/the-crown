...
class Contact extends React.Component{
  constructor(){
    ...
    handleSubmit = (e) => {
      ...
      this.setState({ firstName: firstName, lastName: lastName, email: email, textarea: textarea});
    }
  ...
  render(){
    return(
      <div className="contact">
        ...
        <h1>Contact Us</h1>
          <FormInput type="text" name="firstName" value={this.state.firstName} 
          onChange={this.handleChange} label="First Name"/>

          <FormInput type="text" name="lastName" value={this.state.lastName} 
          onChange={this.handleChange} label="Last Name"/>
